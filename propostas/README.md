...
Diferença para `clientes/`: lá cada pasta é um cliente ativo com `CLIENTE.md` e identidade visual do próprio cliente. Aqui, cada pasta é um prospect e a identidade visual usada é sempre da Pillar (`_squad/_shared/identidade-agencia.md`).

## Estrutura por prospect

```
propostas/<nome-prospect>/
...
Se um prospect virar cliente fechado, a pasta dele passa a viver em `clientes/<nome>/` seguindo o `_TEMPLATE` de lá, não aqui.

...
4. Usar esse registro como insumo pro cronograma de ofertas preditivas (atividade seguinte) e pro dashboard de LTV do `@analista-dados`.

## Cadência recomendada

Atualização contínua, a cada interação com o cliente. Revisão do funil como um todo (quantos clientes em cada fase) mensal.
...
`@analista-dados` estrutura o KPI de retenção. `@copywriter` usa a fase pra calibrar a oferta.

## Operação enxuta

Não precisa de CRM sofisticado pra começar. Uma planilha com nome, contato, última compra e fase estimada já é suficiente pra sustentar as ofertas preditivas da próxima atividade. Ferramenta mais robusta só se justifica quando o volume de clientes tornar a planilha difícil de manter.

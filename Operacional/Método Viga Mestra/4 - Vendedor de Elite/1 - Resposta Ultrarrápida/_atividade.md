# Atividade: Resposta Ultrarrápida

Garantir que todo contato de orçamento (WhatsApp, Instagram, formulário, ligação) seja respondido em até 15 minutos, o padrão do Pilar 4 do Método Viga Mestra.
...
O script é fixo até ser revisado. A medição de tempo de resposta deve ser semanal no início da implementação, depois mensal quando a rotina já estiver consolidada.
...
Não exige ferramenta cara de CRM pra começar. Um combinado simples de plantão entre os vendedores, com o script pronto, já resolve a maior parte do problema. Ferramenta de automação de resposta só faz sentido depois que o volume de contato justificar o investimento.

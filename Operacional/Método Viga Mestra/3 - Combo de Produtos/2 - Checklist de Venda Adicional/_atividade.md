# Atividade: Checklist de Venda Adicional
...
Montagem inicial única por categoria principal, revisão a cada 2-3 meses ou quando o mix de produtos mudar.
...
`@copywriter` monta o checklist e o roteiro de abordagem.

## Operação enxuta

O ganho vem de um checklist curto e realmente usado, não de um documento extenso e ignorado. Melhor ter 5 categorias com checklist ativo no balcão do que 20 categorias documentadas e esquecidas na gaveta.

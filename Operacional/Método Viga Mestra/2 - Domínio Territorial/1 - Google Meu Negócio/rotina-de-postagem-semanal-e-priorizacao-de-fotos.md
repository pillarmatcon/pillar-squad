...
**Fonte do dado:** diagnóstico de Curva ABC e produtos isca do cliente (`outputs/1 - Inteligência de Dados/1 - Curva ABC do Estoque/diagnostico-curva-abc.md`) e, para giro parado/risco de ruptura, `outputs/1 - Inteligência de Dados/2 - Giro de Estoque e Margem/diagnostico-giro-estoque.md`. Nunca estimar giro, faturamento ou margem de cabeça, sempre puxar do diagnóstico real mais recente daquele cliente.

...
**Fonte dos dados:** `outputs/1 - Inteligência de Dados/1 - Curva ABC do Estoque/diagnostico-estoque.md`, seção "Atualização de Estoque: 03/08/2026", e extração direta de `08-2026/estoque-auditado_2026-08-03.xlsx` (aba "Estoque parado (ajustado)")
...
**Composição:** Cumeeira Zincalum 0,43 (parado) + Telha Canal Russa (giro alto, âncora já validada na Fase 4 da estratégia de kits por fase de obra, `outputs/9 - Outros/2026-07-estrategia-kits-e-vendas.md`)
...
Segue o mesmo modelo já validado em `outputs/9 - Outros/2026-07-estrategia-kits-e-vendas.md` (seção 4, Playbook de execução comercial):
...
O CPL de referência de R$ 30-80 do `CLIENTE.md` foi calibrado pra geração de orçamento geral da loja, não pra um SKU específico de ticket mais baixo (Cumeeira R$ 41, Metalon R$ 95, Tela R$ 80/un). Pra este teste, a métrica mais honesta não é CPL isolado, é a **taxa de anexo no PDV** (das vendas do item âncora, quantas saíram com o complemento), a mesma métrica já usada nos outros kits (`outputs/9 - Outros/2026-07-estrategia-kits-e-vendas.md`, seção 4.4). Comparar CPL dos criativos novos contra os atuais da campanha serve como sinal de custo, mas a decisão de continuar ou não depende do PDV, não só do Gerenciador de Anúncios.

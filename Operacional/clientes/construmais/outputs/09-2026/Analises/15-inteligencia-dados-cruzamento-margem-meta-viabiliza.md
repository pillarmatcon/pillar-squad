...
| Inconsistência preço x custo/margem | 147 itens, tolerância de R$ 2 | Não encontrei "147" em nenhum lugar dos dois diagnósticos. O achado mais próximo é "inconsistência entre % Margem cadastrado e o recálculo, tolerância de **2 pontos percentuais**" (não R$ 2), **387 itens**, do snapshot de 03/08/2026 | Não consegui localizar a origem do número 147 nem da tolerância em R$ 2 dentro dos arquivos que tenho. Pode vir de uma checagem embutida direto na planilha padronizada de Curva ABC que não ficou registrada como achado no diagnóstico, ou de uma versão anterior que não encontrei. **Falta confirmar a origem antes de usar esse número em qualquer lugar** |
...
| Faturamento jan-jun/2026 | R$ 1.443.700 (DRE Viabiliza, Receita Bruta) | R$ 1.249.703,92 (soma de jan-mar + abr-jun/2026, Curva ABC) | Diferença de R$ 193.996,08 (13,4%). Pode ser corte de período levemente diferente, tratamento de devolução/imposto na DRE que a Curva ABC não reflete, ou outra fonte de receita que a DRE inclui e a Curva ABC não. Não investiguei a causa, sinalizo a diferença |
...
3. **Origem do número "147 itens, tolerância R$ 2" citado no pedido desta análise.** Não localizei essa contagem nem essa métrica de tolerância em nenhum dos dois diagnósticos da Pillar.
4. **Reconciliação da diferença de R$ 193.996,08 entre a Receita Bruta da DRE da Viabiliza (R$ 1.443.700) e o faturamento somado da Curva ABC pro mesmo semestre (R$ 1.249.703,92).**
5. **Confirmação da premissa usada na seção 1** (outros custos variáveis proporcionais à receita entre categorias), direto com a Viabiliza ou com o Tony, antes de tratar o alvo de "margem bruta ~48,2%" como equivalente confiável da meta de margem de contribuição de 28%.

## Próximos passos

1. Enviar este cruzamento ao Tony e propor perguntar à Viabiliza os itens 1 e 4 da seção 6 (breakdown de custo variável por categoria, reconciliação de receita), sem isso a meta de 28% não tem como ser decomposta por categoria com confiabilidade.
...
5. Confirmar a origem do número "147 itens" antes de citá-lo em qualquer material pro cliente ou pra Viabiliza.

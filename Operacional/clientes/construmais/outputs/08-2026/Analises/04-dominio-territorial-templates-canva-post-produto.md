...
1. **Produto em Destaque** — selo circular com categoria/nome/medida, mesmo espírito do [template-tem-na-construmais.html](../Arquivos/01-dominio-territorial-template-tem-na-construmais.html)

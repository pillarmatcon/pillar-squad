...
- **Fonte da verdade atual do Pilar 1:** `outputs/_diagnosticos/inteligencia-dados/diagnostico-estoque.md` (diagnóstico cumulativo por período, produzido pelo `@inteligencia-dados` com a ferramenta de padronização de Curva ABC). O diagnóstico anterior de 23/07 (`outputs/07-2026/23-diagnostico-estoque.md`, com Curva ABC, giro, margem por categoria, estoque parado, auditoria de dado, produtos isca e 5 candidatos a kit) fica preservado como registro histórico, com banner de superado no topo; os totais de 14 meses foram reconciliados entre as duas análises.
...
- **Horário de funcionamento confirmado direto do perfil (25/07/2026):** segunda a sexta 07:30–17:30, sábado 07:30–16:00, domingo fechado. Resolve a pendência 1 de `outputs/07-2026/24-dominio-territorial-otimizacao-google-meu-negocio.md`.

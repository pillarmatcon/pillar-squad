...
- **Fonte da verdade atual do Pilar 1:** dois diagnósticos cumulativos separados, seguindo o critério de "Formato de output" de `_squad/06-inteligencia-dados/SKILL.md` (migrados em 12/08/2026 do antigo arquivo único `diagnostico-estoque.md`, sem recálculo de nenhum número): `outputs/1 - Inteligência de Dados/1 - Curva ABC do Estoque/diagnostico-curva-abc.md` (faturamento, margem, participação por categoria, giro, produtos isca e candidatos a kit, um período por relatório de Curva ABC) e `outputs/1 - Inteligência de Dados/2 - Giro de Estoque e Margem/diagnostico-giro-estoque.md` (estoque parado, auditoria de cadastro, Grupo Z de cada Curva ABC e o snapshot de estoque mais recente). O diagnóstico anterior de 23/07 (`outputs/2026-07-diagnostico-estoque.md`, com Curva ABC, giro, margem por categoria, estoque parado, auditoria de dado, produtos isca e 5 candidatos a kit) fica preservado como registro histórico, com banner de superado no topo; os totais de 14 meses foram reconciliados entre as duas análises.

...
- Já investe em anúncios atualmente: sim, Google Ads e Meta Ads (Instagram/Facebook). Confirmado (10/08/2026): as campanhas ativas hoje já são geridas pela Pillar, não são remanescentes de antes do contrato. O Alex reativou as que estavam performando melhor como solução temporária, até o site novo e a alocação 85% Google / 15% Meta abaixo estarem totalmente configurados.
...
- **Pixel Meta ID:** 1037733894418340
...
- **2026-08-10:** Tracking completo para Meta Ads e Google Ads confirmado com o Tony. Meta: Pixel ID (1037733894418340) e Ad Account (act_817561456848056). Google Ads: Customer ID (891-156-9115), acesso da Pillar via MCC confirmado, conversion action "Lead WhatsApp 2" (tipo Contato, ID 867725854) já configurada. GA4 ainda não existe, será criado após lançamento do site novo; GTM confirmado como decisão, container ID pendente.

...
Básico perde quase metade do valor bruto (de R$ 20.890 para R$ 10.934,68) por causa de 8 itens com custo mal cadastrado (custo acima do preço de venda): Bucha plástica c/ anel concreto 8mm (22483, R$ 5.377,50), Estribo Flexfer 10x16 (PRD00016, R$ 2.520,00), Bucha plástica tijolo oco 10mm (1592, R$ 752,45), Pó de brita 5m³ (20708, R$ 534,40), Coluna armada 8mm (21344, R$ 279,80), Cabo de aço plastificado 3/32" (4436, R$ 247,93), Estribo de aço 20x9 (21809, R$ 131,20) e Desengraxante 500ml multiuso (21552, R$ 112,04). **Correção em 21/09/2026, apontada pelo cliente: a rodada anterior dizia "4 itens", número errado; são 8, listados na aba "Auditoria outliers cadastro" da planilha filtrando por categoria Básico.** Essa é a leitura que uso pra falar de capital parado por categoria daqui pra frente, o valor bruto por categoria fica documentado mas não é a base de decisão.

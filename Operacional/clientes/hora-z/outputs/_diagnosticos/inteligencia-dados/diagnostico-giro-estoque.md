...
- O relatório de estoque original ("Produtos por Fornecedor") lista 544 linhas para 443 SKUs únicos: 86 códigos aparecem em mais de uma linha (101 linhas extras ao todo, alguns códigos com até 4 linhas) porque já foram comprados de mais de um fornecedor ao longo do tempo. Estoque disponível e preço de venda são idênticos entre as linhas duplicadas do mesmo código (confirmado: nenhum dos 86 códigos tem estoque disponível diferente entre as linhas, a quantidade física não está duplicada), só custo, fornecedor e data de compra variam. Deduplicei mantendo a linha com a compra mais recente, como proxy de custo de reposição atual.
- **Limitação apontada pelo cliente em 18/09/2026: essa escolha de custo (compra mais recente) muda o "valor em estoque a custo" de quem tem mais de um fornecedor.** Exemplo concreto: Cimento Supremo 50kg (código PRD00045) tem 2 linhas, mesmas 95 unidades em estoque nas duas, mas custo de R$ 36,90 (Becker, comprado em 11/06/2026) e R$ 33,00 (Agremix, comprado em 09/09/2026, mais recente). Usei R$ 33,00 (valor em estoque R$ 3.135,00), não R$ 36,90 (que daria R$ 3.505,50). Levantei o impacto agregado nos 86 códigos com mais de um custo cadastrado: a diferença entre usar o custo mais alto e o mais baixo já registrado soma R$ 6.152,97, cerca de 15% do valor total em estoque a custo (R$ 40.661,03). Não é dado duplicado nem erro de conta, é escolha de metodologia (custo mais recente como proxy de reposição, mais defensável que média ou mínimo/máximo), mas o valor de estoque a custo deste diagnóstico é uma estimativa sensível a essa escolha, não um número contábil fechado. Os casos de maior impacto individual: Parafuso ponta broca 12 5,5mm (código 22924, R$ 1.335,38 de diferença), Tijolo 6 furos 09x14x24 (código 22114, R$ 927,67), Tijolo 6 furos 09x14x29 (código 20250, R$ 896,83), Cabo de aço plastificado 3/32" (código 4436, R$ 629,19) e o próprio Cimento Supremo 50kg (R$ 370,50). Lista completa dos 86 códigos com o custo mínimo, máximo e o usado na aba "Sensibilidade custo fornecedor" da planilha.
...
8. Definir com o cliente qual custo usar para os 86 SKUs comprados de mais de um fornecedor (hoje uso a compra mais recente como proxy de reposição): se o ERP tiver custo médio ponderado ou custo de reposição já calculado, ele é mais confiável do que a escolha feita aqui e destrava até R$ 6.152,97 de ajuste no valor total em estoque.

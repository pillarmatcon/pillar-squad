# Atividade: Bônus e Cashback de Recompra
...
Definição da regra uma vez, com revisão trimestral ou sempre que a margem do material fino mudar.
...
`@copywriter` escreve a comunicação do benefício. A regra financeira precisa de confirmação do dono da loja antes de qualquer divulgação.

## Operação enxuta

Um mecanismo simples e sempre cumprido gera mais confiança e recompra do que uma promoção elaborada que o cliente não entende ou desconfia. Começar com uma regra única e fácil de explicar em uma frase, só sofisticar depois que a base estiver validada.

...
3. **Checar performance anterior (cliente ativo).** Se houver RESUMO DE PERFORMANCE em `Operacional/clientes/<nome>/outputs/`, leio antes de escrever (ver princípio 9). Se for cliente novo, pulo esta etapa.

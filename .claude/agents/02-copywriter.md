---
name: copywriter
description: Copywriter de resposta direta para clientes B2C - headlines, anúncios, e-mails, scripts, e playbook de atendimento/follow-up de orçamento (Pilar Vendedor de Elite do Método Viga Mestra). Carrega instruções de Claude/_squad/02-copywriter/SKILL.md ao ser invocado.
---
...
1. `Claude/_squad/02-copywriter/SKILL.md` - sua identidade, papel e workflow
...
6. Para playbook de atendimento/follow-up de cliente MatCon: `Claude/_squad/_shared/metodo-viga-mestra.md` (Pilar 4, Vendedor de Elite)
7. Qualquer arquivo adicional em `Claude/_squad/02-copywriter/`

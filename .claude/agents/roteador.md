...
|---|---|---|
| Classificar/extrair/resumir muitos itens (>20), parsing em massa, análise de planilhas grandes | DeepSeek | `python orquestracao-multi-ia/workers/deepseek_bulk.py --entrada <jsonl> --system <prompt_fixo> --saida <jsonl>` |
...
6. Registre no final da tarefa (`orquestracao-multi-ia/tasks/<nome>.md`) um bloco `## Log` com: worker usado, comando, custo estimado impresso pelo script.
